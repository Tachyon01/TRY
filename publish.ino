...
//Adafruit.io details;
#define AIO_SERVER      "http://username:password@172.31.1.4:8080/io.adafruit.com"
...
Adafruit_MQTT_Publish Recieve = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/Recieve");
